...
plot_data(time, amplitude, 'Time', 'Amplitude', 'sin_wave.png', title='4 Hz Sine Wave', plot_type='stem')
...
'Frequency', 'Power', 'sin_wave_fft.png', title='FFT of 4 Hz Sine Wave', y_lim=[0,20], plot_type='stem')

#modify
time = time[:-minus_step]
amplitude = amplitude[:-minus_step]

plot_data(time, amplitude, 'Time', 'Amplitude', 'sin_wave-modified.png', title='Unfinished 4 Hz Sine Wave', plot_type='stem')
